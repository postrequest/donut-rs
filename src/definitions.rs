...
pub const xCLSID_CorRuntimeHost: GUID = GUID {
    ...
    data_2: 0xab3a,
    data_3: 0x11d2,
    data_4: [0x9c, 0x40, 0x00, 0xc0, 0x4f, 0xa3, 0x0a, 0x3e],
};
...
pub const xCLSID_CLRMetaHost: GUID = GUID {
    ...
    data_2: 0xe8e,
    data_3: 0x4867,
    data_4: [0xb3, 0xc, 0x7f, 0xa8, 0x38, 0x84, 0xe8, 0xde],
};
...
pub const xIID_ICLRMetaHost: GUID = GUID {
    ...
    data_2: 0xB9B3,
    data_3: 0x4125,
    data_4: [0x82, 0x07, 0xA1, 0x48, 0x84, 0xF5, 0x32, 0x16],
};
...
pub const xIID_ICLRRuntimeInfo: GUID = GUID {
    ...
    data_2: 0xBA2F,
    data_3: 0x486a,
    data_4: [0x89, 0xB0, 0xB4, 0xB0, 0xCB, 0x46, 0x68, 0x91],
};
...
pub const xIID_AppDomain: GUID = GUID {
    ...
    data_2: 0x2B29,
    data_3: 0x3663,
    data_4: [0xAD, 0x8B, 0xC4, 0x38, 0x9C, 0xF2, 0xA7, 0x13],
};
...
pub const xIID_IUnknown: GUID = GUID {
    ...
    data_2: 0x0000,
    data_3: 0x0000,
    data_4: [0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46],
};
...
pub const xIID_IHost: GUID = GUID {
    ...
    data_2: 0x5feb,
    data_3: 0x43f5,
    data_4: [0xb0, 0x28, 0xe2, 0xca, 0x96, 0x06, 0x17, 0xec],
};
...
pub const xIID_IActiveScript: GUID = GUID {
    ...
    data_2: 0xa4f9,
    data_3: 0x11cf,
    data_4: [0x8f, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64],
};
...
pub const xIID_IActiveScriptParse64: GUID = GUID {
    ...
    data_2: 0xe1ee,
    data_3: 0x480e,
    data_4: [0x97, 0xea, 0xd5, 0x2c, 0xb4, 0xd7, 0x6d, 0x17],
};
...
pub const xCLSID_VBScript: GUID = GUID {
    ...
    data_2: 0x5B07,
    data_3: 0x11cf,
    data_4: [0xA4, 0xB0, 0x00, 0xAA, 0x00, 0x4A, 0x55, 0xE8],
};
...
pub const xCLSID_JScript: GUID = GUID {
    ...
    data_2: 0x6AC0,
    data_3: 0x11CF,
    data_4: [0xB6, 0xD1, 0x00, 0xAA, 0x00, 0xBB, 0xBB, 0x58],
};

pub fn generate_api_imports() -> Vec<ApiImport> {
    vec![
        ApiImport {
            module: KERNEL32_DLL.to_string(),
        ...
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "VirtualQuery".to_string(),
        }, // 5
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "VirtualProtect".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
        ...
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "MultiByteToWideChar".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "GetUserDefaultLCID".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
        ...
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "GetThreadContext".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "GetCurrentThread".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "GetCommandLineA".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "GetCommandLineW".to_string(),
        }, // 15
        ApiImport {
            module: SHELL32_DLL.to_string(),
            name: "CommandLineToArgvW".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayCreate".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayCreateVector".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayPutElement".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayDestroy".to_string(),
        }, // 20
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayGetLBound".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SafeArrayGetUBound".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SysAllocString".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "SysFreeString".to_string(),
        },
        ApiImport {
            module: OLEAUT32_DLL.to_string(),
            name: "LoadTypeLib".to_string(),
        }, // 25
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetCrackUrlA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetOpenA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetConnectA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetSetOptionA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetReadFile".to_string(),
        }, // 30
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "InternetCloseHandle".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "HttpOpenRequestA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "HttpSendRequestA".to_string(),
        },
        ApiImport {
            module: WININET_DLL.to_string(),
            name: "HttpQueryInfoA".to_string(),
        },
        ApiImport {
            module: MSCOREE_DLL.to_string(),
            name: "CorBindToRuntime".to_string(),
        }, // 35
        ApiImport {
            module: MSCOREE_DLL.to_string(),
            name: "CLRCreateInstance".to_string(),
        },
        ApiImport {
            module: OLE32_DLL.to_string(),
            name: "CoInitializeEx".to_string(),
        },
        ApiImport {
            module: OLE32_DLL.to_string(),
            name: "CoCreateInstance".to_string(),
        },
        ApiImport {
            module: OLE32_DLL.to_string(),
            name: "CoUninitialize".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlEqualUnicodeString".to_string(),
        }, // 40
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlEqualString".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlUnicodeStringToAnsiString".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlInitUnicodeString".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlExitUserThread".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlExitUserProcess".to_string(),
        }, // 45
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlCreateUnicodeString".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlGetCompressionWorkSpaceSize".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "RtlDecompressBuffer".to_string(),
        },
        ApiImport {
            module: NTDLL_DLL.to_string(),
            name: "NtContinue".to_string(),
        },
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "AddVectoredExceptionHandler".to_string(),
        }, // 50
        ApiImport {
            module: KERNEL32_DLL.to_string(),
            name: "RemoveVectoredExceptionHandler".to_string(),
        },
    ]
}
